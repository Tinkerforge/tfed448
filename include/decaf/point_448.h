...
DECAF_API_VIS extern const size_t decaf_448_sizeof_precomputed_s, decaf_448_alignof_precomputed_s;
...
/** The scalar 1. */
extern const decaf_448_scalar_t DECAF_API_VIS decaf_448_scalar_one;

/** The scalar 0. */
extern const decaf_448_scalar_t DECAF_API_VIS decaf_448_scalar_zero;

/** The identity (zero) point on the curve. */
extern const decaf_448_point_t DECAF_API_VIS decaf_448_point_identity;

/** An arbitrarily-chosen base point on the curve. */
extern const decaf_448_point_t DECAF_API_VIS decaf_448_point_base;

/** Precomputed table of multiples of the base point on the curve. */
extern const struct DECAF_API_VIS decaf_448_precomputed_s *decaf_448_precomputed_base;


#else // _MSC_VER

/** The scalar 1. */
DECAF_API_VIS extern const decaf_448_scalar_t decaf_448_scalar_one;

/** The scalar 0. */
DECAF_API_VIS extern const decaf_448_scalar_t decaf_448_scalar_zero;

/** The identity (zero) point on the curve. */
DECAF_API_VIS extern const decaf_448_point_t decaf_448_point_identity;

/** An arbitrarily-chosen base point on the curve. */
DECAF_API_VIS extern const decaf_448_point_t decaf_448_point_base;

/** Precomputed table of multiples of the base point on the curve. */
DECAF_API_VIS extern const struct decaf_448_precomputed_s *decaf_448_precomputed_base;
 ...
 */
decaf_error_t DECAF_API_VIS decaf_448_scalar_decode (
 ...
 * @param [out] out Deserialized form.
 */
void DECAF_API_VIS decaf_448_scalar_decode_long (
    decaf_448_scalar_t out,
 ...
 */
void DECAF_API_VIS decaf_448_scalar_encode (
 ...
 * @param [out] out a+b.
 */
void DECAF_API_VIS decaf_448_scalar_add (
    decaf_448_scalar_t out,
 ...
 */    
decaf_bool_t DECAF_API_VIS decaf_448_scalar_eq (
    const decaf_448_scalar_t a,
    const decaf_448_scalar_t b
) DECAF_WARN_UNUSED DECAF_NONNULL DECAF_NOINLINE;
 ...
 * @param [out] out a-b.
 */  
void DECAF_API_VIS decaf_448_scalar_sub (
    decaf_448_scalar_t out,
    const decaf_448_scalar_t a,
    const decaf_448_scalar_t b
) DECAF_NONNULL DECAF_NOINLINE;
 ...
 * @param [out] out a*b.
 */  
void DECAF_API_VIS decaf_448_scalar_mul (
    decaf_448_scalar_t out,
    const decaf_448_scalar_t a,
    const decaf_448_scalar_t b
) DECAF_NONNULL DECAF_NOINLINE;
...
* @param [out] out a/2.
*/
void DECAF_API_VIS decaf_448_scalar_halve (
   decaf_448_scalar_t out,
   const decaf_448_scalar_t a
) DECAF_NONNULL DECAF_NOINLINE;
 ...
 */  
decaf_error_t DECAF_API_VIS decaf_448_scalar_invert (
    decaf_448_scalar_t out,
    const decaf_448_scalar_t a
) DECAF_WARN_UNUSED DECAF_NONNULL DECAF_NOINLINE;
 ...
 */  
void DECAF_API_VIS decaf_448_scalar_set_unsigned (
    decaf_448_scalar_t out,
    uint64_t a
) DECAF_NONNULL;
 ...
 */
void DECAF_API_VIS decaf_448_point_encode (
 ...
 */
decaf_error_t DECAF_API_VIS decaf_448_point_decode (
 ...
 */
decaf_bool_t DECAF_API_VIS decaf_448_point_eq (
 ...
 */
void DECAF_API_VIS decaf_448_point_add (
 ...
 * @param [in] a A point.
 */
void DECAF_API_VIS decaf_448_point_double (
 ...
 */
void DECAF_API_VIS decaf_448_point_sub (
 ...
 */
void DECAF_API_VIS decaf_448_point_negate (
 ...
 */
void DECAF_API_VIS decaf_448_point_scalarmul (
 ...
 */
decaf_error_t DECAF_API_VIS decaf_448_direct_scalarmul (
 ...
 */
decaf_error_t DECAF_API_VIS decaf_x448 (
 ...
 */
void DECAF_API_VIS decaf_448_point_mul_by_ratio_and_encode_like_x448 (
 ...
 */
void DECAF_API_VIS decaf_x448_generate_key (
    uint8_t out[DECAF_X448_PUBLIC_BYTES],
    const uint8_t scalar[DECAF_X448_PRIVATE_BYTES]
) DECAF_NONNULL DECAF_NOINLINE DECAF_DEPRECATED("Renamed to decaf_x448_derive_public_key");
 ...
 * @param [in] scalar The private scalar.
 */
void DECAF_API_VIS decaf_x448_derive_public_key (
    uint8_t out[DECAF_X448_PUBLIC_BYTES],
    const uint8_t scalar[DECAF_X448_PRIVATE_BYTES]
) DECAF_NONNULL DECAF_NOINLINE;
 ...
 * @param [in] b Any point.
 */
void DECAF_API_VIS decaf_448_precompute (
 ...
 * @param [in] scalar The scalar to multiply by.
 */
void DECAF_API_VIS decaf_448_precomputed_scalarmul (
    decaf_448_point_t scaled,
 ...
 */
void DECAF_API_VIS decaf_448_point_double_scalarmul (
 ...
 * @param [in] scalar2 A second scalar to multiply by.
 */
void DECAF_API_VIS decaf_448_point_dual_scalarmul (
 ...
 *
 * @retval DECAF_SUCCESS The multiplication succeeded.
 * @retval DECAF_OUT_OF_MEMORY Scratch memory allocation failed.
 */
decaf_error_t DECAF_API_VIS decaf_448_base_double_scalarmul_non_secret (
    decaf_448_point_t combo,
    const decaf_448_scalar_t scalar1,
    const decaf_448_point_t base2,
    const decaf_448_scalar_t scalar2
 ...
 */
void DECAF_API_VIS decaf_448_point_cond_sel (
 ...
 */
void DECAF_API_VIS decaf_448_scalar_cond_sel (
    decaf_448_scalar_t out,
    const decaf_448_scalar_t a,
    const decaf_448_scalar_t b,
    decaf_word_t pick_b
 ...
 */
decaf_bool_t DECAF_API_VIS decaf_448_point_valid (
 ...
 */
void DECAF_API_VIS decaf_448_point_debugging_torque (
    decaf_448_point_t q,
    const decaf_448_point_t p
) DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
void DECAF_API_VIS decaf_448_point_debugging_pscale (
    decaf_448_point_t q,
    const decaf_448_point_t p,
 ...
 * @param [out] pt The data hashed to the curve.
 */ 
void DECAF_API_VIS decaf_448_point_from_hash_uniform (
    decaf_448_point_t pt,
...
void DECAF_API_VIS decaf_448_scalar_destroy (
 ...
 */
void DECAF_API_VIS decaf_448_point_destroy (
 ...
 */
void DECAF_API_VIS decaf_448_precomputed_destroy (
